...
#                print "result file is " + resultfile
            ...
            if resultfile[len(resultfile)-5] == "1" :
                try:
                    run_command("./%s 512 16 fifo direct %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                ...
                try:
                    run_command("./%s 512 16 fifo assoc %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                ...
                try:
                    run_command("./%s 512 16 fifo assoc:4 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "my score is ", myscore
                ...
                try:
                    run_command("./%s 512 8 fifo assoc:8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 1 fifo assoc:2 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 32 4 lru assoc:2 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 128 32 lru assoc %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True, echo=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
            ...
            if os.system(command)==0:
                ...
                if (resultfile[len(resultfile)-5] == "7" or resultfile[len(resultfile)-5] == "6"):
                    myscore = myscore + 3.75
                else:
                    myscore = myscore + 5
...
def single_grade(dirname):
    ...
    for testfile in sorted(os.listdir(input_dir)):
        ...
        for resultfile in sorted(os.listdir(output_dir)):
            ...
            if resultfile[len(resultfile)-5] == "1" :
                try:
                    run_command("./%s 512 direct 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "my score is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:4 16 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "my score is ", myscore
                ...
                try:
                    run_command("./%s 512 assoc:8 8 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
                ...
                try:
                    run_command("./%s 1024 assoc:2 1 %s > %s"%(dirname, input_dir + "/" + testfile,resultfile), timeout=runtime[dirname], user_program=True);
                except:
                    print "An exception occurred while executing %s %s"%(dirname, testfile)
                    os.chdir(prevdir)
                    print "myScore is ", myscore
